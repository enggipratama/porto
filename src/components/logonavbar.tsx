    ...
    <div className="relative z-50">
      ...
      >
        ...
        >
          ...
          />
          <h1 className="text-sm sm:text-l text-center justify-center font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-900 via-purple-700 to-pink-800 animate-pulse">
            Double Tap_
          </h1>
        </div>
      </Draggable>
        ...
        {isMenuVisible && (
          <motion.div
            ...
            style={{
              ...
              left: logoPosition.x - menuOffset + 20,
            ...
            <ul>
              <li>
                <a
                  ...
                  className="block py-2 text-white text-sm sm:text-base transition-transform duration-200 transform hover:scale-120"
                >
                  Home
                </a>
              </li>
